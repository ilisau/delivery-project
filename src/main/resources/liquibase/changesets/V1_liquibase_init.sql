...
CREATE TABLE "restaurants_employees"
(
    "restaurant_id" BIGINT NOT NULL,
...
ALTER TABLE "users_roles"
    ADD CONSTRAINT "fk_users_roles_users" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE;

-- changeset solvd:1674032559630-38
CREATE TABLE "couriers_roles"
(
...
ALTER TABLE "couriers_roles"
    ADD CONSTRAINT "fk_couriers_roles_couriers" FOREIGN KEY ("courier_id") REFERENCES "couriers" ("id") ON UPDATE NO ACTION ON DELETE CASCADE;

-- changeset solvd:1674032559630-40
...
-- changeset solvd:1674032559630-41
ALTER TABLE "employees_roles"
    ADD CONSTRAINT "fk_employees_roles_employees" FOREIGN KEY ("employee_id") REFERENCES "employees" ("id") ON UPDATE NO ACTION ON DELETE CASCADE;