...
CREATE TABLE "items" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 4) NOT NULL, "name" VARCHAR(45) NOT NULL, "description" VARCHAR(255), "price" numeric(8, 2) NOT NULL, "type" VARCHAR(45) NOT NULL, "available" BOOLEAN DEFAULT TRUE NOT NULL, CONSTRAINT "items_pkey" PRIMARY KEY ("id"));

-- changeset solvd:1674032559630-2
CREATE TABLE "couriers" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 4) NOT NULL, "first_name" VARCHAR(45) NOT NULL, "last_name" VARCHAR(45) NOT NULL, "phone_number" VARCHAR(45) NOT NULL, "created_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "last_active_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "status" VARCHAR(45) NOT NULL, "email" VARCHAR(45) NOT NULL unique, "password" VARCHAR(65) NOT NULL, CONSTRAINT "couriers_pkey" PRIMARY KEY ("id"));

-- changeset solvd:1674032559630-3
CREATE TABLE "restaurants" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 2) NOT NULL, "name" VARCHAR(45) NOT NULL, "description" VARCHAR(255), CONSTRAINT "restaurants_pkey" PRIMARY KEY ("id"));

-- changeset solvd:1674032559630-4
CREATE TABLE "users" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 2) NOT NULL, "cart_id" BIGINT NOT NULL, "name" VARCHAR(45) NOT NULL, "email" VARCHAR(45) NOT NULL, "password" VARCHAR(65) NOT NULL, "phone_number" VARCHAR(45) NOT NULL, "created_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, CONSTRAINT "users_pkey" PRIMARY KEY ("id"));
...
CREATE TABLE "addresses" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 4) NOT NULL, "street_name" VARCHAR(45) NOT NULL, "house_number" INTEGER NOT NULL, "floor_number" INTEGER, "flat_number" INTEGER, CONSTRAINT "addresses_pkey" PRIMARY KEY ("id"));

-- changeset solvd:1674032559630-11
CREATE TABLE "carts" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 3) NOT NULL, CONSTRAINT "carts_pkey" PRIMARY KEY ("id"));
...
CREATE TABLE "employees" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 4) NOT NULL, "name" VARCHAR(45) NOT NULL, "position" VARCHAR(45) NOT NULL, CONSTRAINT "employees_pkey" PRIMARY KEY ("id"));

-- changeset solvd:1674032559630-14
CREATE TABLE "orders" ("id" BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 2) NOT NULL, "address_id" BIGINT NOT NULL, "cart_id" BIGINT NOT NULL, "courier_id" BIGINT, "status" VARCHAR(45) NOT NULL, "created_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL, "delivered_at" TIMESTAMP WITHOUT TIME ZONE, CONSTRAINT "orders_pkey" PRIMARY KEY ("id"));
...
-- changeset solvd:1674032559630-36
CREATE TABLE "users_roles" ("user_id" BIGINT NOT NULL, "role" VARCHAR(45) NOT NULL);

-- changeset solvd:1674032559630-37
ALTER TABLE "users_roles" ADD CONSTRAINT "fk_users_roles_users" FOREIGN KEY ("user_id") REFERENCES "users" ("id") ON UPDATE NO ACTION ON DELETE CASCADE;

-- changeset solvd:1674032559630-38
CREATE TABLE "couriers_roles" ("courier_id" BIGINT NOT NULL, "role" VARCHAR(45) NOT NULL);

-- changeset solvd:1674032559630-39
ALTER TABLE "couriers_roles" ADD CONSTRAINT "fk_couriers_roles_couriers" FOREIGN KEY ("courier_id") REFERENCES "couriers" ("id") ON UPDATE NO ACTION ON DELETE CASCADE;